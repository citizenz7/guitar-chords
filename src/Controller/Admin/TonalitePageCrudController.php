...
class TonalitePageCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return TonalitePage::class;
    }
    ...
    {
        return $crud
            ->setPageTitle('index', 'Page Tonalités')
            ->setPageTitle('edit', 'Modifier la page Tonalités')
            ->setPageTitle('detail', 'Page Tonalités')
